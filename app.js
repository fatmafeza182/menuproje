...
const all =document.querySelector(".all-center");
...
const allList =() =>{
  ...
  .map((button) => {
    return `<button class="btn btn-outline-dark btn-item" data-id="${button}">${button}</button>`;
  ...
  filterButtons.forEach(button =>{
    button.addEventListener("click",(e)=>{
      ...
      if (buttonId==="All"){
        ...
        const filteredMenu =menu.filter((item)=>item.category===buttonId);
